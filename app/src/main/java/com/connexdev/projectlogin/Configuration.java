...
public class Configuration {
        ...
        ////////////////  MODUL SISWA/PD  ////////////////////////////////////////////////////////
        public static final String URL_ADD_PD="http://10.10.18.85/api_sekolah/pd/tambah_pd.php";
        public static final String URL_GET_ALL_PD = "http://10.10.18.85/api_sekolah/pd/tampil_pd.php";
        public static final String URL_GET_EMP_PD = "http://10.10.18.85/api_sekolah/pd/detail_pd.php?nis=";
        public static final String URL_UPDATE_EMP_PD = "http://10.10.18.85/api_sekolah/pd/update_pd.php";
        public static final String URL_DELETE_EMP_PD = "http://10.10.18.85/api_sekolah/pd/hapus_pd.php?nis=";
        ...
        public static final String URL_ADD_GURU=
                "http://192.168.10.171/api_sekolah/guru/tambah_guru.php";
        public static final String URL_GET_ALL_GURU =
                "http://192.168.10.171/api_sekolah/guru/tampil_guru.php";
        public static final String URL_GET_EMP_GURU =
                "http://192.168.10.171/api_sekolah/guru/detail_guru.php?kdguru=";
        public static final String URL_UPDATE_EMP_GURU =
                "http://192.168.10.171/api_sekolah/guru/update_guru.php";
        public static final String URL_DELETE_EMP_GURU =
                "http://192.168.10.171/api_sekolah/guru/hapus_guru.php?kdguru=";
        //Dibawah ini merupakan script atau perintah untuk mengirim permintaan kedalam Skrip PHP
      ...
      public static final String URL_ADD_NEWUSER = "http://10.10.18.85/api_sekolah/user/tambah.php";
       public static final String KEY_EMP_USERNAME = "username";
       public static final String KEY_EMP_PASSWORD = "password";
       public static final String TAG_JSON_ARRAY_USERNAME = "result";
