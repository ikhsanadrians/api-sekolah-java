...
//dekalarasi variabel
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kdguru = intent.getStringExtra(Configuration.EMP_ID_GURU);
    ...
    private void getEmployee() {
        class GetEmployee extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(Configuration.URL_GET_EMP_GURU, kdguru);
                return s;
            }
        }
    ...
    private void showEmployee(String json) {
        try {
            ...
            JSONArray result = jsonObject.getJSONArray(Configuration.TAG_JSON_ARRAY_GURU);
            JSONObject c = result.getJSONObject(0);
            String nip = c.getString(Configuration.TAG_NIP_GURU);
            String name = c.getString(Configuration.TAG_NAMA_GURU);
            String desg = c.getString(Configuration.TAG_KELAMIN_GURU);
            String sal = c.getString(Configuration.TAG_ALAMAT_GURU);
    ...
    private void updateEmployee() {
        ...
        class UpdateEmployee extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(Configuration.KEY_EMP_ID_GURU, kdguru);
                hashMap.put(Configuration.KEY_EMP_NIP_GURU, nip);
                hashMap.put(Configuration.KEY_EMP_NAMA_GURU, name);
                hashMap.put(Configuration.KEY_EMP_KELAMIN_GURU, jk);
                hashMap.put(Configuration.KEY_EMP_ALAMAT_GURU, alamat);


                RequestHandler rh = new RequestHandler();

                String s = rh.sendPostRequest(Configuration.URL_UPDATE_EMP_GURU, hashMap);
    ...
    private void deleteEmployee() {
        class DeleteEmployee extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam(Configuration.URL_DELETE_EMP_GURU, kdguru);
                return s;
            }
        }
    ...
    public void onClick(View v) {
        ...
        if (v == buttonHome) {
            startActivity(new Intent(DetileGuru.this,CrudHomePage.class));
        }
